...
// Register custom template path for bbPress.
add_action( 'bbp_register_theme_packages', 'um_theme_bbpress_template' );
...
/*
 * get the bbPress template paths
 */
if ( ! function_exists( 'um_theme_bbpress_template' ) ) {
	function um_theme_bbpress_template() {
		return UM_THEME_DIR . '/bbpress';
	}
}
			...
			if ( ! empty( $reply_count ) ) {
				...
				<div class="boot-row boot-align-items-center">
					<div class="boot-col-3">
						<span class="topic-info-number"><?php echo esc_attr( $topic_text );?></span>
						<span class="topic-info-title"><?php esc_html_e( 'Topic', 'um-theme' );?></span>
					</div>
					<div class="boot-col-3">
						<span class="topic-info-number"><?php echo esc_attr( $reply_text );?></span>
						<span class="topic-info-title"><?php esc_html_e( 'Replies', 'um-theme' );?></span>
					</div>
					<div class="boot-col-3">
						<span class="topic-info-number"><?php echo esc_attr( $time_since );?></span>
						<span class="topic-info-title"><?php esc_html_e( 'Recent activity', 'um-theme' );?></span>
					</div>
					<div class="boot-col-3">
						<span class="topic-info-number"><?php echo esc_attr( $last_updated_by );?></span>
